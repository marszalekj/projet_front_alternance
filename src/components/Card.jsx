...
const Card = (props) => {
    return (
<div className="relative max-h-[120px] min-h-[60px] min-w-[20px] max-w-lg  rounded-lg border	border-gray-200 bg-gradient-to-tr from-teal-700 to-black shadow duration-300 hover:scale-110 hover:opacity-50 md:max-h-[160px] md:max-w-xs lg:max-h-[220px] lg:max-w-sm">
