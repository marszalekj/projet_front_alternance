...
const Social = () => {
    return(
        ...
        <p className="flex pb-6 text-center font-lato text-lg md:text-xl ">You can also find me on Twitch, where I stream myself coding,<br/> an exercise that allows me to follow my progress and get advice from other developers</p>
